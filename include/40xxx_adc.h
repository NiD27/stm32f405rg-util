...
#define ADC_SR_RESET 0x00000000
typedef struct{
    uint32_t AWD :1;
    uint32_t EOC :1;
    uint32_t JEOC :1;
...
#define ADC_CR1_RESET 0x00000000
typedef struct{
    uint32_t AWDCH :5;
    uint32_t EOCIE :1;
    uint32_t AWDIE :1;
...
#define ADC_CR2_RESET 0x00000000
typedef struct{
    uint32_t ADON :1;
    uint32_t CONT :1;
    uint32_t RESERVED_1 :6;
...
#define ADC_SMPR1_RESET 0x00000000
typedef struct{
    uint32_t SMP10 :3;
    uint32_t SMP11 :3;
    uint32_t SMP12 :3;
...
#define ADC_SMPR2_RESET 0x00000000
typedef struct{
    uint32_t SMP0 :3;
    uint32_t SMP1 :3;
    uint32_t SMP2 :3;
...
#define ADC_JOFR_RESET 0x00000000
typedef struct{
    uint32_t JOFFSET :12;
...
#define ADC_HTR_RESET 0x00000fff
typedef struct{
    uint32_t HT :12;
    uint32_t RESERVED :20;
}ADC_HTR_ST;
...
#define ADC_LTR_RESET 0x00000000
typedef struct{
    uint32_t LT :12;
    uint32_t RESERVED :20;
}ADC_LTR_ST;
...
#define ADC_SQR1_RESET 0x00000000
typedef struct{
    uint32_t SQ13 :5;
    uint32_t SQ14 :5;
    uint32_t SQ15 :5;
...
#define ADC_SQR2_RESET 0x00000000
typedef struct{
    uint32_t SQ7 :5;
    uint32_t SQ8 :5;
    uint32_t SQ9 :5;
...
#define ADC_SQR3_RESET 0x00000000
typedef struct{
    uint32_t SQ1 :5;
    uint32_t SQ2 :5;
    uint32_t SQ3 :5;
...
#define ADC_JSQR_RESET 0x00000000
typedef struct{
    uint32_t JSQ1 :5;
    uint32_t JSQ2 :5;
    uint32_t JSQ3 :5;
...
#define ADC_JDR_RESET 0x00000000
typedef struct{
    uint32_t JDATA :16;
...
#define ADC_DR_RESET 0x00000000
typedef struct{
    uint32_t DATA :12;
...
#define ADC_CSR_RESET 0x00000000
typedef struct{
...
#define ADC_CCR_RESET 0x00000000
typedef struct{
    uint32_t MULTI :5;
...
#define ADC_CDR_RESET 0x00000000
typedef struct{
    uint32_t DATA1 :16;
    uint16_t DATA2 :16;
}ADC_CDR_ST;
