...
#define ADC1_COMMON_REGISTERS_ADDRESS (ADC1_BASE_OFFSET+ADC_COMMON_REGISTERS_OFFSET)
#define ADC2_COMMON_REGISTERS_ADDRESS (ADC2_BASE_OFFSET+ADC_COMMON_REGISTERS_OFFSET)
#define ADC3_COMMON_REGISTERS_ADDRESS (ADC3_BASE_OFFSET+ADC_COMMON_REGISTERS_OFFSET)

#define ADC_CSR_OFFSET 0x300
#define ADC1_CSR_ADDRESS (ADC_BASE_ADDRESS+ADC1_BASE_OFFSET+ADC_CSR_OFFSET)
#define ADC2_CSR_ADDRESS (ADC_BASE_ADDRESS+ADC2_BASE_OFFSET+ADC_CSR_OFFSET)
#define ADC3_CSR_ADDRESS (ADC_BASE_ADDRESS+ADC3_BASE_OFFSET+ADC_CSR_OFFSET)
...
#define ADC1_CCR_ADDRESS (ADC_BASE_ADDRESS+ADC1_BASE_OFFSET+ADC_CCR_OFFSET)
#define ADC2_CCR_ADDRESS (ADC_BASE_ADDRESS+ADC2_BASE_OFFSET+ADC_CCR_OFFSET)
#define ADC3_CCR_ADDRESS (ADC_BASE_ADDRESS+ADC3_BASE_OFFSET+ADC_CCR_OFFSET)
...
#define ADC1_CDR_ADDRESS (ADC_BASE_ADDRESS+ADC1_BASE_OFFSET+ADC_CDR_OFFSET)
#define ADC2_CDR_ADDRESS (ADC_BASE_ADDRESS+ADC2_BASE_OFFSET+ADC_CDR_OFFSET)
#define ADC3_CDR_ADDRESS (ADC_BASE_ADDRESS+ADC3_BASE_OFFSET+ADC_CDR_OFFSET)
